'''
This application using for handling cache, client request -> cache handle  : 1. will ask cache " is there any package save in cache before or not?"
if not, then ask main server -> send back to client.
'''
